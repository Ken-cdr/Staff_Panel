...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 08, 2025 at 12:47 PM
...
(1, 'Long Sleeves black', 'Plain Black Long Sleeves size xl', './uploads/long sleeves.jpg', 555, 1, '2022-03-28'),
(2, 'T-Shirt Anime', 'Casual Fit', './uploads/t shirt.jpg', 890, 1, '2022-04-04'),
(3, 'Jersey', 'Jersey', './uploads/jersey.jpg', 200, 2, '2022-04-04'),
(4, 'Polo Shirt', 'Polo', './uploads/polo.jpg', 200, 1, '2022-04-04'),
(5, 'Short', 'Sport Ware', './uploads/short.jpg', 300, 3, '2022-04-04'),
(6, 'Black T shirt', 'Black guko anime shirt size L', './uploads/T-shirt anime black.jpg', 500, 1, '2025-02-05');
...
INSERT INTO `return_products` (`rp_id`, `user_id`, `delivered_to`, `phone_no`, `deliver_address`, `pay_method`, `product_status`, `process_status`, `order_date`) VALUES
(1, 2, 'Al', '9802234675', 'Pasig', 'GCash', 0, 1, '2022-04-10'),
(2, 2, 'Alan', '980098322', 'Cainta', 'Bank Transfer', 0, 1, '2022-04-18'),
(3, 2, 'Lex', '980098322', 'Taytay', 'Gcash', 0, 1, '2022-04-18');
...
--
ALTER TABLE `order_details`
  ADD CONSTRAINT `order_details_ibfk_1` FOREIGN KEY (`order_id`) REFERENCES `return_products` (`rp_id`),
...
--
ALTER TABLE `return_products`
  ADD CONSTRAINT `return_products_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`user_id`);
COMMIT;
